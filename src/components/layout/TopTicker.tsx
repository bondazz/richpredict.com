...
export default function TopTicker({ children }: { children?: React.ReactNode }) {
    const items = [
    ...
    return (
        <div className="bg-[#001e28] border-b border-white/5 h-10">
            <div className="max-w-[1240px] mx-auto w-full h-full relative px-4 flex items-center overflow-hidden">
                {children ? (
                    <div className="flex items-center text-[10px] font-black uppercase tracking-wider w-full overflow-x-auto whitespace-nowrap scrollbar-hide">
                        {children}
                    </div>
                ) : (
                    <>
