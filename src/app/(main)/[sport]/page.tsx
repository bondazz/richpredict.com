...
import { getPredictions, getRegions, getPinnedLeagues, getCountriesByRegion, getPremiumPredictionsCount, Prediction, getTeams } from "@/lib/supabase";
                                    ...
                                    return (
                                        <div key={match.id} className="event__match group flex items-center h-14 hover:bg-white/[0.04] transition-colors relative border-b border-black/10">
                                            ...
                                            <Link
                                                ...
                                                aria-label={`View expert preview for ${match.home_team} vs ${match.away_team}`}
                                            />
                                        </div>
                                    );
                                })}
